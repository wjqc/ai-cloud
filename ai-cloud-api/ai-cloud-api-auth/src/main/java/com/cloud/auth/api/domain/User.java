...
public class User extends BaseEntity {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("bindQqId", getBindQqId())
            .append("bindWechatId", getBindWechatId())
            .append("bindSinaId", getBindSinaId())
            .append("bindAlipayId", getBindAlipayId())
            ...
            .append("invitationUrlAnd", getInvitationUrlAnd())
            .append("invitationUrlIos", getInvitationUrlIos())
            .append("invitationUrlWeixin", getInvitationUrlWeixin())
            .append("invitationIds", getInvitationIds())
            ...
            .append("weixinAvatar", getWeixinAvatar())
